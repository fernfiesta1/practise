...
/**
 * @author dbrit00s * You are given coins of different denominations and a total
 *         amount of money. Write a function to compute the number of
 *         combinations that make up that amount. You may assume that you have
 *         infinite number of each kind of coin.
 * 
 *         Note: You can assume that
 * 
 *         0 <= amount <= 5000 1 <= coin <= 5000 the number of coins is less
 *         than 500 the answer is guaranteed to fit into signed 32-bit integer
 *         Example 1:
 * 
 ...
 *         cannot be made up just with coins of 2. Example 3: Input: amount =
 *         10, coins = [10] Output: 1
 * 
 *         NOTE: If asked number of combinations(only going forward), then for
 *         bottom up outer loop is coins and inner loop is amount.
 *
 * 
 */
